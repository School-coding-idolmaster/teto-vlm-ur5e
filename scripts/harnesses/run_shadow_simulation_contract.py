...
`scripts/teto_operator_console.py`. Current Isaac default:
`scripts/start_teto_isaac_gui_operator.sh`. Dry-run, plan-only, fake, or Isaac
evidence from this historical script is not REAL_PATH success evidence.
"""
