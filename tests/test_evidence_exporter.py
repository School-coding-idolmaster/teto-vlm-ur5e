...
def test_dry_run_execution_writes_evidence_artifacts(tmp_path):
    ...
    assert "TETO version: TETO V2.8.2" in summary
    ...
    assert manifest["teto_version"] == "TETO V2.8.2"
...
def test_evidence_exporter_writes_micro_motion_manifest_and_summary(tmp_path):
    ...
    assert "# TETO V2.8.2 Simulation Micro-Motion Evidence Report" in report
