...
Dry-run, plan-only, fake, RGB-only, or Isaac evidence from this launcher is not
...
def handle_first_simulation_execution():
    ...
    print(
        ...
        "--observe-articulation-state --check-simulation-motion-precheck "
