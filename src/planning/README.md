...
guidance lives in `docs/module_guides/planning.md`.
...
This package is only a future boundary. H12-B does not change runtime behavior,
startup behavior, real robot behavior, Isaac behavior, parser/model-service
behavior, imports, or safety semantics.
