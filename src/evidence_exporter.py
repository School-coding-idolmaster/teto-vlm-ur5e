...
def export_simulation_evidence(
    ...
    *,
    ...
    manifest = {
        ...
        "rgb_ref": camera_source_info.get("rgb_ref") or camera_source_info.get("image_ref"),
        ...
        "tf_snapshot_ref": camera_source_info.get("tf_snapshot_ref")
        or camera_source_info.get("extrinsics_ref"),
    ...
    *,
    ...
    return "\n".join(
        [
            ...
            f"- rgb_ref: {_format_value(camera_source_info.get('rgb_ref') or camera_source_info.get('image_ref'))}",
            ...
            f"- tf_snapshot_ref: {_format_value(camera_source_info.get('tf_snapshot_ref') or camera_source_info.get('extrinsics_ref'))}",
